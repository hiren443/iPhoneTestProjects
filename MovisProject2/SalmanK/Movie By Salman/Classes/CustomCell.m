...
- (id)initWithFrame:(CGRect)frame reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithFrame:frame reuseIdentifier:reuseIdentifier]) {
		...
		[btn setImage:[UIImage imageNamed:@"Share_button_d.png"] forState:UIControlStateNormal];
		//[btn setBackgroundImage:[UIImage imageNamed:@"btn.png"] forState:normal];
//		[btn setTitle:@"Share" forState:normal];
		...
		//[checkBoxButton setImage:[UIImage imageNamed:@"chkbox.png"] forState:UIControlStateNormal];
...
-(void)layoutSubviews
{
    ...
    btn.frame = CGRectMake(210, 0, 90, 82);
